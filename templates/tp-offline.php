<?php
/* Template Name: Offline Template */
get_header();
global $SVG;
...
<main role="main">
    ...
    <section class="events" id="events">
        ...
        <div class="wrapper">
            <?php
            $events_list = $offline_fields['events_list'];
    ...
    <section class="scenes" id="scenes">
        ...
        <div class="wrapper">
            ...
            <h2 class="section-title"><?php echo $offline_fields['scenes_title'] ?></h2>

            <div class="section-description"><?php echo $offline_fields['scenes_description'] ?></div>

            <?php
            $gallery = $offline_fields['scenes_gallery'];
